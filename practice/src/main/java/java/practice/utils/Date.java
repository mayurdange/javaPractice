 ...
 * @see     java.practice.utils.Calendar
 * @see     java.practice.utils.TimeZone
 * @since   JDK1.0
 */
public class Date
    implements java.io.Serializable, Cloneable, Comparable<Date>
{
    ...
    /* use serialVersionUID from modified java.practice.utils.Date for
     ...
     * @see     java.text.DateFormat
     * @see     java.practice.utils.Date#parse(java.lang.String)
     * @deprecated As of JDK version 1.1,
     ...
     *          <code>false</code> otherwise.
     * @see     java.practice.utils.Date#getTime()
     */
     ...
     * @see     java.practice.utils.Date#toLocaleString()
     * @see     java.practice.utils.Date#toGMTString()
     */
     ...
     *          conventions.
     * @see     java.text.DateFormat
     * @see     java.practice.utils.Date#toString()
     * @see     java.practice.utils.Date#toGMTString()
     * @deprecated As of JDK version 1.1,
     ...
     * @see     java.practice.utils.Calendar#ZONE_OFFSET
     * @see     java.practice.utils.Calendar#DST_OFFSET
     * @see     java.practice.utils.TimeZone#getDefault
     * @deprecated As of JDK version 1.1,
