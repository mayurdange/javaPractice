...
import java.practice.utils.ArrayList;
import java.practice.utils.Arrays;
import java.practice.utils.Collection;
import java.practice.utils.Collections;
import java.practice.utils.List;
import java.practice.utils.concurrent.AbstractExecutorService;
import java.practice.utils.concurrent.Callable;
import java.practice.utils.concurrent.ExecutorService;
import java.practice.utils.concurrent.Future;
import java.practice.utils.concurrent.RejectedExecutionException;
import java.practice.utils.concurrent.RunnableFuture;
import java.practice.utils.concurrent.ThreadLocalRandom;
import java.practice.utils.concurrent.TimeUnit;
import java.practice.utils.concurrent.atomic.AtomicLong;
 ...
 * <ul>
 * <li>{@code java.practice.utils.concurrent.ForkJoinPool.common.parallelism}
 * - the parallelism level, a non-negative integer
 * <li>{@code java.practice.utils.concurrent.ForkJoinPool.common.threadFactory}
 * - the class name of a {@link ForkJoinWorkerThreadFactory}
 * <li>{@code java.practice.utils.concurrent.ForkJoinPool.common.exceptionHandler}
    ...
    private static ForkJoinPool makeCommonPool() {
        ...
        try {  // ignore exceptions in accessing/parsing properties
            String pp = System.getProperty
                ("java.practice.utils.concurrent.ForkJoinPool.common.parallelism");
            String fp = System.getProperty
                ("java.practice.utils.concurrent.ForkJoinPool.common.threadFactory");
            String hp = System.getProperty
                ("java.practice.utils.concurrent.ForkJoinPool.common.exceptionHandler");
            if (pp != null)
