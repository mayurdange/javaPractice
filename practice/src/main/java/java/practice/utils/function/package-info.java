 ...
 *     {@link java.practice.utils.function.Function} (unary function from {@code T} to {@code R}),
 *     {@link java.practice.utils.function.Consumer} (unary function from {@code T} to {@code void}),
 *     {@link java.practice.utils.function.Predicate} (unary function from {@code T} to {@code boolean}),
 *     and {@link java.practice.utils.function.Supplier} (nilary function to {@code R}).
 *     </li>
 *
 ...
 *     {@link java.practice.utils.function.BiFunction} (binary function from {@code T} and
 *     {@code U} to {@code R}).
 *     </li>
 *
 *     <li>There are additional derived function shapes which extend the basic
 *     function shapes, including {@link java.practice.utils.function.UnaryOperator}
 *     (extends {@code Function}) and {@link java.practice.utils.function.BinaryOperator}
 ...
 *     prefix {@code ToXxx}, as in {@link java.practice.utils.function.ToIntFunction}.
 *     Otherwise, type arguments are specialized left-to-right, as in
 *     {@link java.practice.utils.function.DoubleConsumer}
 *     or {@link java.practice.utils.function.ObjIntConsumer}.
 ...
 *     as in {@link java.practice.utils.function.ObjIntConsumer}.)
 ...
 *     prefix may be left out (as in {@link java.practice.utils.function.ObjIntConsumer}).
 *     </li>
 * </ul>
 *
 ...
 * @since 1.8
 */
package java.practice.utils.function;
